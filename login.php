...
<body>
	<nav>
	    <div class="nav-wrapper  teal darken-4">
	      	<a href="#" class="brand-logo center">Webgenerator Ana Lucía Basaldúa</a>
	    </div>
  	</nav>
  	<br>
  	<br>
						...
						<form method="GET">
						    ...
						    <div class="row">
						    	<div class="col offset-s4 offset-m4 offset-l5">
						    		<input type="submit" class="center-align waves-effect waves-light btn ee" id="btnLogin" name="btn" value="Iniciar">
						    	</div>
						    </div>
						    <div class="msg">
						    	<?php
